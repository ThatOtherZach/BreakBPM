      ...
      >
        ...
        {pricing.isLoading ? (
          ...
          <>
            ...
            <div className="notice" style={{ color: "#7a2a00" }}>Ads are subject to Admin Review. If approved it goes live for your chosen days; if denied, it never displays. No refunds, including on denial.</div>
