...
export const POOL_STATS_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Yes. Every game has a five character join code. Others can join an open slot before the break or spectate by name to see the shot log and live BPM.",
  },
  {
