...
export interface AppConfig {
   ...
   */
  qrUrl: string;
  /** Off-platform card store (Squarespace) URL where buyers can purchase the 30 Day Pass by card; the owner then emails a redeem code. Configurable via the BREAKBPM_STORE_URL env var; empty string when unset, in which case the client hides the card-store callout.
   */
  storeUrl: string;
